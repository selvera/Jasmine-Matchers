declare namespace any {
    function after (otherDate: Date): AsymmetricMatcher;
    function arrayOfBooleans (): AsymmetricMatcher;
    function arrayOfNumbers (): AsymmetricMatcher;
    function arrayOfObjects (): AsymmetricMatcher;
    function arrayOfSize (size: number): AsymmetricMatcher;
    function arrayOfStrings (): AsymmetricMatcher;
    function before (otherDate: Date): AsymmetricMatcher;
    function calculable (): AsymmetricMatcher;
    function emptyArray (): AsymmetricMatcher;
    function emptyObject (): AsymmetricMatcher;
    function endingWith (substring: string): AsymmetricMatcher;
    function evenNumber (): AsymmetricMatcher;
    function greaterThanOrEqualTo (otherValue: number): AsymmetricMatcher;
    function iso8601 (): AsymmetricMatcher;
    function jsonString (): AsymmetricMatcher;
    function lessThanOrEqualTo (otherValue: number): AsymmetricMatcher;
    function longerThan (otherValue: string): AsymmetricMatcher;
    function nonEmptyArray (): AsymmetricMatcher;
    function nonEmptyObject (): AsymmetricMatcher;
    function nonEmptyString (): AsymmetricMatcher;
    function oddNumber (): AsymmetricMatcher;
    function sameLengthAs (otherValue: string): AsymmetricMatcher;
    function shorterThan (otherValue: string): AsymmetricMatcher;
    function startingWith (substring: string): AsymmetricMatcher;
    function whitespace (): AsymmetricMatcher;
    function wholeNumber (): AsymmetricMatcher;
    function withinRange (floor: number, ceiling: number): AsymmetricMatcher;
