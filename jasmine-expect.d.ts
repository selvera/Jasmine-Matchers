...
declare namespace any {
  interface AsymmetricMatchers {
    after(otherDate: Date): AsymmetricMatcher;
    ...
    before(otherDate: Date): AsymmetricMatcher;
    calculable(): AsymmetricMatcher;
    emptyArray(): AsymmetricMatcher;
    emptyObject(): AsymmetricMatcher;
    endingWith(otherString: string): AsymmetricMatcher;
    evenNumber(): AsymmetricMatcher;
    greaterThanOrEqualTo(otherNumber: number): AsymmetricMatcher;
    iso8601(): AsymmetricMatcher;
    jsonString(): AsymmetricMatcher;
    lessThanOrEqualTo(otherNumber: number): AsymmetricMatcher;
    longerThan(otherString: string): AsymmetricMatcher;
    ...
    regExp(): AsymmetricMatcher;
    sameLengthAs(otherString: string): AsymmetricMatcher;
    shorterThan(otherString: string): AsymmetricMatcher;
    startingWith(otherString: string): AsymmetricMatcher;
...
declare namespace jasmine {
  interface Matchers<T> {
    ...
    toEndWith(otherString: string, expectationFailOutput?: any): boolean;
    ...
    toStartWith(otherString: string, expectationFailOutput?: any): boolean;
